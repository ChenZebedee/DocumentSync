...
```sh
yum install gcc make binutils gcc-c++ compat-libstdc++-33 elfutils-libelf-devel elfutils-libelf-devel-static ksh libaio libaio-devel numactl-devel sysstat unixODBC unixODBC-devel pcre-devel zip unzip -y
```
...
```sh
cat << EOF > /home/oracle/response/db_install.rsp
####################################################################
...
#-------------------------------------------------------------------------------
INVENTORY_LOCATION=/orcldata/oracle/inventory
...
#------------------------------------------------------------------------------
ORACLE_HOME=/orcldata/oracle/product/11.2.0
...
```sh
sh /orcldata/oracle/inventory/orainstRoot.sh
sh /orcldata/oracle/product/11.2.0/root.sh
```

### 监听

```sh
netca /silent /responseFile /data/response/netca.rsp
```

### 创建实例

```
dbca -silent -responseFile /data/response/dbca.rsp
```